    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10}}>
          <div>
            <div style={{fontSize: small?15:18,fontWeight:900,color:"#fff"}}>
              💳 Bulk Payment Report
            </div>
          ...
          >
            ...
            {bulkUploading
              ? <div style={{color:"#60a5fa",fontSize:12,fontWeight:700}}>⏳ جاري التحليل...</div>
              : bulkSuccess
              ? <div style={{color:"#22c55e",fontSize:12,fontWeight:700}}>✅ تم التحديث</div>
              : <>
        ...
        {activeTab==='daily' && (
          <div>
              ...
              {(d.daily||[]).map((day,i)=>{
                ...
                return (
                  <div key={i} style={{
                    ...
                    gap:2,minWidth: small?20:28,flex:"0 0 auto"
                  }}>
                    <div style={{
                      fontSize:8,color:"#888",fontWeight:600,
                      textAlign:"center",lineHeight:1.2
                    }}>
                      {total>0?omr(total).slice(0,-4):''}
                    </div>
                    <div style={{
                      width:"100%",height:Math.max(pct,3)+"%",
                      background:isMax?"#e85d20":"#1e3a5f",
                      borderRadius:"3px 3px 0 0",
                      opacity:isMax?1:0.6+i*0.01,
                      minHeight:3
                    }}/>
                  </div>
                );
            ...
            <div style={{display:"flex",gap:3,overflowX:"auto",marginBottom:12}}>
              {(d.daily||[]).map((day,i)=>(
                <div key={i} style={{
                  minWidth: small?20:28,flex:"0 0 auto",
                  textAlign:"center",fontSize:8,color:"#aaa",
                  fontWeight:600
                }}>{day.date.slice(8)}</div>
              ))}
            </div>
            {/* جدول يومي */}
            <div style={{maxHeight:300,overflowY:"auto"}}>
              <div style={{
                display:"grid",gridTemplateColumns:"100px 1fr 130px 80px",
                gap:6,padding:"6px 8px",
                background:"#1e3a5f",borderRadius:8,marginBottom:6
              }}>
                {["التاريخ","شريط","المدفوع","عدد"].map((h,i)=>(
              ...
              {[...(d.daily||[])].reverse().map((day,i)=>(
                <div key={i} style={{
                  ...
                  borderRadius:7,marginBottom:3,border:"1px solid #f0ece8"
                }}>
                  ...
                  <div style={{background:"#f0ece8",borderRadius:4,height:8,overflow:"hidden"}}>
                    <div style={{
                      width:((day.paid+day.adj)/maxDaily*100)+"%",
                      height:"100%",background:"#1e3a5f",borderRadius:4
                    }}/>
                  </div>
                  <div style={{fontSize:13,fontWeight:800,color:"#16a34a",textAlign:"center"}}>{omr(day.paid+day.adj)}</div>
          ...
          <div>
            {(d.byRegion||[]).map((r,i)=>(
              <div key={i} style={{
                ...
                <div style={{textAlign:"center"}}>
                  <span style={{
                    fontSize:11,background:`${r.color||'#888'}22`,
                    color:r.color||'#888',borderRadius:6,
        ...
        {activeTab==='collector' && (
          <div>
            <div style={{
              ...
              background:"#1e3a5f",borderRadius:8,marginBottom:8
            }}>
...
function HistoryModal({ history, onClose, small }) {
  const [view, setView] = useState('list'); // list | chart | compare
  ...
  const omr = n => new Intl.NumberFormat("en-US",{minimumFractionDigits:3,maximumFractionDigits:3}).format(n||0);
  const short = n => n >= 1000000 ? (n/1000000).toFixed(2)+'M' : n >= 1000 ? (n/1000).toFixed(1)+'K' : (n||0).toFixed(0);

  const sorted = [...history].sort((a,b) => new Date(b.date) - new Date(a.date));

  // حساب التغيير بين يومين
  const diff = (a, b, key) => {
    const va = a[key]||0, vb = b[key]||0;
    const d = va - vb;
    const pct = vb > 0 ? ((d/vb)*100).toFixed(1) : '0';
    return { d, pct, up: d >= 0 };
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width:"100%", maxWidth: small?400:900,
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{fontSize:11,color:"rgba(255,255,255,0.6)",marginTop:2}}>
              {history.length} يوم محفوظ · آخر 90 يوم
            </div>
          </div>
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            {/* أزرار التبويب */}
            {[['list','📋 السجل'],['compare','⚖️ مقارنة'],['chart','📊 رسم بياني']].map(([v,l])=>(
        ...
        <div style={{flex:1,overflow:"auto",padding:"16px 20px"}}>
          ...
          {view === 'list' && (
            <div>
              <div style={{
                display:"grid",
                gridTemplateColumns: small?"1fr":"40px 1fr 140px 140px 160px",
                ...
                {(small?["التاريخ","الإجمالي"]:["#","التاريخ","المدفوع","التسويات","الإجمالي الكلي"]).map((h,i)=>(
                  <div key={i} style={{fontSize:12,fontWeight:800,color:"#fff",textAlign:i>1?"center":"right"}}>{h}</div>
                ))}
              </div>
              {sorted.map((entry,i) => {
                const prev = sorted[i+1];
                const change = prev ? diff(entry,prev,'grandTotal') : null;
                return (
                  <div key={i} style={{
                    display:"grid",
                    gridTemplateColumns: small?"1fr":"40px 1fr 140px 140px 160px",
                    ...
                    <div style={{fontSize:13,color:"#aaa",fontWeight:700}}>{i+1}</div>
                    <div>
                      <div style={{fontSize:14,fontWeight:800,color:"#111"}}>{entry.date}</div>
                      <div style={{fontSize:11,color:"#888",marginTop:2}}>
                        {entry.totalRecords?.toLocaleString()} سجل
                        {change && (
                          <span style={{
                            marginRight:8,
                    ...
                    {!small && <>
                      <div style={{textAlign:"center",fontSize:13,fontWeight:800,color:"#16a34a"}}>{omr(entry.grandPaid)}</div>
                      <div style={{textAlign:"center",fontSize:13,fontWeight:800,color:"#d97706"}}>{omr(entry.grandAdj)}</div>
                    </>}
                    <div style={{
                      textAlign:"center",fontSize:15,fontWeight:900,color:"#e85d20",
                      display:"flex",flexDirection:"column",justifyContent:"center"
                    }}>
                      {omr(entry.grandTotal)}
                      <span style={{fontSize:10,color:"#aaa",fontWeight:600}}>OMR</span>
                    </div>
                  </div>
                );
              })}
            ...
            <div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:16}}>
                {[["اليوم الأول",compareA,setCompareA],["اليوم الثاني",compareB,setCompareB]].map(([label,val,set],idx)=>(
                  <div key={idx}>
                    <div style={{fontSize:12,color:"#555",fontWeight:700,marginBottom:6}}>{label}</div>
                    <select
                      value={val}
                      onChange={e=>set(Number(e.target.value))}
                      style={{width:"100%",padding:"8px 12px",borderRadius:8,border:"1.5px solid #e5e7eb",
                        fontSize:13,fontFamily:"'Cairo',sans-serif",color:"#111"}}
                    >
                      {sorted.map((h,i)=>(
                        <option key={i} value={i}>{h.date} — {omr(h.grandTotal)}</option>
                      ))}
                    </select>
                  </div>
                ))}
                ...
                return (
                  <div>
                    <div style={{
                      ...
                      background:"#1e3a5f",borderRadius:10,marginBottom:8
                    }}>
                      {["البيان",a.date,b.date,"الفرق"].map((h,i)=>(
                        <div key={i} style={{fontSize:12,fontWeight:800,color:"#fff",textAlign:i>0?"center":"right"}}>{h}</div>
                      ))}
                    </div>
                    {rows.map(([label,key,color])=>{
                      ...
                      return (
                        <div key={key} style={{
                          ...
                          <div style={{fontSize:13,fontWeight:800,color:"#333"}}>{label}</div>
                          <div style={{textAlign:"center",fontSize:13,fontWeight:800,color}}>{key==='totalRecords'?va.toLocaleString():omr(va)}</div>
                          <div style={{textAlign:"center",fontSize:13,fontWeight:800,color:"#888"}}>{key==='totalRecords'?vb.toLocaleString():omr(vb)}</div>
                          <div style={{
                            textAlign:"center",fontSize:13,fontWeight:900,
                            color:d>=0?"#16a34a":"#dc2626"
                          }}>
                            {d>=0?"▲":"▼"} {Math.abs(Number(pct))}%
                          </div>
                        </div>
                      );
                    })}
                    ...
                    {/* مقارنة المحافظات */}
                    <div style={{marginTop:16,fontWeight:800,fontSize:14,color:"#1e3a5f",marginBottom:8}}>
                      مقارنة المحافظات
                    </div>
                    {a.regions?.map((ra,i)=>{
                      const rb = b.regions?.[i];
                      if (!rb) return null;
                      const da=ra.paid+ra.adj, db=rb.paid+rb.adj, d=da-db;
                      const pct=db>0?((d/db)*100).toFixed(1):'0';
                      return (
                        <div key={i} style={{
                          display:"grid",gridTemplateColumns:"1fr 1fr 1fr 100px",
                          ...
                          <div style={{fontSize:12,fontWeight:700,color:"#333"}}>{ra.nameAr}</div>
                          <div style={{textAlign:"center",fontSize:12,fontWeight:800,color:"#e85d20"}}>{omr(da)}</div>
                          <div style={{textAlign:"center",fontSize:12,fontWeight:700,color:"#888"}}>{omr(db)}</div>
                          <div style={{textAlign:"center",fontSize:12,fontWeight:800,color:d>=0?"#16a34a":"#dc2626"}}>
                            {d>=0?"▲":"▼"}{Math.abs(Number(pct))}%
                          </div>
                        </div>
                      );
          ...
          {view === 'chart' && (
            <div>
              ...
              {/* رسم بياني بـ CSS bars */}
              {(() => {
                const items = sorted.slice(0,30).reverse();
                const maxV = Math.max(...items.map(h=>h.grandTotal),1);
                return (
                  <div>
                    <div style={{display:"flex",alignItems:"flex-end",gap:4,height:200,padding:"0 8px",borderBottom:"2px solid #f0ece8",marginBottom:8}}>
                      {items.map((h,i)=>{
                        const pct=(h.grandTotal/maxV)*100;
                        const isLast = i===items.length-1;
                        return (
                          <div key={i} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:4}}>
                            <div style={{fontSize:9,color:"#888",fontWeight:600,textAlign:"center"}}>
                              {omr(h.grandTotal).replace(',','').slice(0,7)}
                            </div>
                            <div style={{
                              width:"100%",height:pct+"%",minHeight:4,
                              background: isLast?"#e85d20":"#fbd5b5",
                    ...
                    <div style={{
                      ...
                      {[
                        ["أعلى يوم",omr(Math.max(...sorted.map(h=>h.grandTotal))),"#16a34a"],
                        ["أدنى يوم",omr(Math.min(...sorted.map(h=>h.grandTotal))),"#dc2626"],
                        ["المتوسط",omr(sorted.reduce((s,h)=>s+h.grandTotal,0)/sorted.length),"#e85d20"],
                      ].map(([l,v,c])=>(
                        <div key={l} style={{
...
const LOGO_B64 = "data:image/png;base64,";
    ...
    reader.onload = async (e) => {
      try {
        ...
        const REG_COLORS = {
          ...
          'الشرقية والوسطى': '#d4601a', 'مسندم والبريمي': '#b03808',
          'ظفار': '#f07030',
        };

        const g = v => parseFloat(v) || 0;
        let totalPaid = 0, totalAdj = 0;
        const dailyMap = {}, regionMap = {}, collectorMap = {};
        ...
        rows.forEach(row => {
          ...
          if (dateStr) {
            ...
            dailyMap[dateStr].paid += paid;
            dailyMap[dateStr].adj  += adj;
          ...
          // محصّل
          if (collector) {
            if (!collectorMap[collector]) collectorMap[collector] = {name:collector,paid:0,adj:0,count:0};
            collectorMap[collector].paid += paid; collectorMap[collector].adj += adj; collectorMap[collector].count++;
          }
        });
