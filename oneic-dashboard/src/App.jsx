...
const SEED = {
  ...
  regions: [
    { id:"sharqiah",   nameAr:"الشرقية والوسطى",          nameEn:"Ash Sharqiyah & Al Wusta",
      ...
      collectors:[
        ...
        { name:"Shima Yousuf Al Mukhaini",     paid:2753.593,  adj:270.712   },
        { name:"Shiiab Al Habsi",              paid:1196.977,  adj:530.471   },
        ...
        { name:"Ghaliya Mubarak",              paid:1150.515,  adj:133.038   },
        { name:"Ahmed Salim Al Mahruqi",       paid:1209.212,  adj:80.262    },
        { name:"Zainab Mabrouk",               paid:2574.620,  adj:493.689   },
        { name:"Badar Khamis Al Malkhi",       paid:1679.427,  adj:354.169   },
      ]
    },
    { id:"batinah",    nameAr:"الباطنة",                  nameEn:"Al Batinah",
      paid:58907.061,  adj:14917.782,
      collectors:[
    ...
    { id:"musandam",   nameAr:"مسندم والظاهرة والبريمي",  nameEn:"Musandam, Al Dahirah & Al Buraimi",
      paid:33087.380,  adj:4048.733,
      collectors:[
  ...
  debtCompanies: [
    { name:"Balqees Abdullah",   paid:41.555,       adj:3311.597  },
    { name:"Rasheeda",           paid:41547.426,    adj:9064.084  },
    { name:"Ejada4",             paid:230873.588,   adj:26426.701 },
    { name:"Yousef",             paid:11364.106,    adj:643.403   },
    { name:"Nabhan",             paid:14405.459,    adj:1785.281  },
    { name:"Salah",              paid:29229.378,    adj:1218.462  },
    { name:"Faisal",             paid:13420.145,    adj:357.302   },
    { name:"Ekhlas",             paid:14147.415,    adj:503.569   },
    { name:"hala alamri",        paid:43269.215,    adj:4629.450  },
    { name:"Abdul Aziz",         paid:6343.141,     adj:993.179   },
    { name:"Mohammed Al Adiwi",  paid:9807.599,     adj:152.150   },
    { name:"Khamis  Sultan",     paid:42048.506,    adj:3818.288  },
    { name:"Hamood Al-Harthyi",  paid:33852.225,    adj:5577.229  },
    { name:"Maryam Rashid",      paid:18244.047,    adj:1790.557  },
    { name:"Rayan",              paid:16591.879,    adj:502.131   },
    { name:"Shifa",              paid:13084.992,    adj:1518.997  },
    { name:"Safiya",             paid:22327.450,    adj:484.380   },
    { name:"Haidy",              paid:6888.091,     adj:1574.393  },
    { name:"Thikra",             paid:6820.982,     adj:0.000     },
    { name:"Matrix1",            paid:4684.488,     adj:801.754   },
    { name:"Iman",               paid:10947.457,    adj:565.886   },
    { name:"Yustina",            paid:9556.791,     adj:967.564   },
    { name:"Fahad Al-Harith",    paid:2145.555,     adj:153.060   },
    { name:"Israa",              paid:7162.314,     adj:1454.084  },
    { name:"Omnia",              paid:7364.093,     adj:1213.593  },
    { name:"OmniaH",             paid:7920.499,     adj:770.927   },
    { name:"Matrix2",            paid:919.014,      adj:329.338   },
    { name:"Hamood Al abri",     paid:15189.790,    adj:2439.299  },
    { name:"Ali",                paid:4807.150,     adj:260.905   },
    { name:"Ejada2",             paid:3894.414,     adj:151.494   },
    { name:"Speed staff",        paid:5927.788,     adj:67.577    },
    { name:"Samia",              paid:2276.260,     adj:172.225   },
    { name:"Mohammed",           paid:1279.185,     adj:0.000     },
  ],
  headOffice: [
...
async function parseXLS(file) {
  ...
  rows.forEach(row => {
    ...
    if (region === 'Debt Collection Company') {
      // نستخدم اسم المحصّل (Collector) كمفتاح، مع حفظ اسم الشركة (Branch)
      const key = col || branch || 'Unknown';
      if (!dcMap[key]) dcMap[key] = { paid:0, adj:0, count:0, paidCount:0, adjCount:0, osAmt:0, principalAmt:0, company:branch };
    ...
    reader.onload = e => {
      try {
        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          if (region === DC_REGION) {
            // نستخدم اسم المحصّل كمفتاح، مع الشركة كـ metadata
            const dcKey = collector2 || branch || 'Unknown';
            dcCount++; dcAmt += amt; dcPaid += paidAmt; dcAdj += adjAmt;
            if (dcKey) {
              if (!branchMap[dcKey]) branchMap[dcKey] = {count:0, amt:0, paid:0, adj:0, company:branch};
              branchMap[dcKey].count++; branchMap[dcKey].amt += amt; branchMap[dcKey].paid += paidAmt; branchMap[dcKey].adj += adjAmt;
            }
